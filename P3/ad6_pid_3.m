...
hold on
fig = stairs(y_zad);
writematrix([fig.XData; fig.YData]','txts/ad6_pid_3_y_zad.txt', "Delimiter","tab");
fig = stairs(y);
writematrix([fig.XData; fig.YData]','txts/ad6_pid_3_y.txt', "Delimiter","tab");
hold off
figure()
hold on
fig = stairs(u);
writematrix([fig.XData; fig.YData]','txts/ad6_pid_3_u.txt', "Delimiter","tab");
hold off
disp(norm(y_zad-y))
save("data/ad4_pid_3_ga.mat")
